...
class Trader:
    ...
    # Faster fill-rate version of copytrader_scaled. This tests whether the
    # official flow still gives us the early high-premium lots at larger size.
    VOUCHER_LIMITS = {5300: 300, 5400: 300, 5500: 300}
    VOUCHER_QTYS = {5300: 12, 5400: 18, 5500: 18}
